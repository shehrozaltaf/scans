                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="box box-widget widget-user-2">
                                        ...
                                        <div class="widget-user-header bg-blue">
                                            ...
                                            foreach ($clusters_by_district->result() as $row1) {
                                                $target_clusters = $target_clusters + $row1->clusters_by_district;
                                            } ?>
                                            ...
                                            <div class="box-footer no-padding">
                                                <ul class="nav nav-stacked">
                                                    ...
                                                    <?php foreach ($clusters_by_district->result() as $row2) {
                                                        ...
                                                        ?>
                                                        <li><a href="#"><strong><?php echo $district; ?></strong><span
                                                                        class="pull-right badge bg-blue"><?php echo $row2->clusters_by_district; ?></span></a>
                                                        </li>
                                                    <?php } ?>
                            ...
                            <table id="get_list" class="table table-bordered table-responsive" width="100%">
                                ...
                                foreach ($get_list->result() as $row5) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row5->randomized_households; ?></strong></td>
                                        <td>
                                        ...
                                        <td><?php echo $row5->completed_households; ?></td>
                                        <td><?php echo $row5->mc_cnt; ?></td>
