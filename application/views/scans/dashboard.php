              ...
              <div class="row">
                  ...
                  <div class="box box-widget widget-user-2">
                    ...
                    <div class="box-footer no-padding">
                      <ul class="nav nav-stacked">
                        ...
                        ?>
                        <li><a href="<?php echo base_url().'scans/dashboard/rc_d'.$row4->dist_id;?>"><strong><?php echo $district2;?></strong><span class="pull-right badge bg-orange"><?php echo $row4->randomized_c;?></span></a></li>
                        <?php } ?>
                ...
                <div class="col-md-3">
                  ...
                  <div class="box box-widget widget-user-2">
                    ...
                    <div class="box-footer no-padding">
                      <ul class="nav nav-stacked">
                        <li><a href="<?php echo base_url().'scans/dashboard/cc_d2';?>"><strong>Punjab</strong><span class="pull-right badge bg-green"><?php echo $cc_d2;?></span></a></li>
                        <li><a href="<?php echo base_url().'scans/dashboard/cc_d3';?>"><strong>Sindh</strong><span class="pull-right badge bg-green"><?php echo $cc_d3;?></span></a></li>
                      </ul>
                    </div>
                    <?php } ?>
                ...
                <div class="col-md-3">
                  ...
                  <div class="box box-widget widget-user-2">
                    ...
                    <div class="box-footer no-padding">
                      <ul class="nav nav-stacked">
                        <li><a href="<?php echo base_url().'scans/dashboard/rc_d2';?>"><strong>Punjab</strong><span class="pull-right badge bg-red"><?php echo $rc_d2;?></span></a></li>
                        <li><a href="<?php echo base_url().'scans/dashboard/rc_d3';?>"><strong>Sindh</strong><span class="pull-right badge bg-red"><?php echo $rc_d3;?></span></a></li>
                      </ul>
                    </div>
                    <?php } ?>
              ...
              <table id="get_list" class="table table-bordered table-responsive" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td><strong><a href="<?php echo base_url().'scans/cluster_progress/'.$row5->hh02;?>" class="name" target="_blank"><?php echo $row5->collected_households;?></a></strong></td>
